...
> mantenido en los últimos años una tendencia de crecimiento sostenido, situándose en el
> entorno de los 20.000 millones de euros por trimestre. El dato refuerza la idea de que
> la tienda online es un canal de negocio serio y no un adorno.
...
| Imagen | Plantilla de solo lectura a partir de la cual se crean contenedores (ejemplo: `wordpress:6.4`). |
...
| `depends_on` | Directiva que indica el orden de arranque entre servicios. |
