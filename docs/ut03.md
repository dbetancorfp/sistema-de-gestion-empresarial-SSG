...
**RA3.** Realiza operaciones de gestión, consulta y análisis de la información siguiendo
las especificaciones de diseño y utilizando las herramientas que proporciona el propio
sistema ERP-CRM.

En términos llanos, superar este resultado supone ser capaz de moverse con soltura por los
...
rinde como debe. Los criterios de evaluación asociados son:
...
como la resolución (criterio de evaluación g).
...
El criterio de evaluación e) pide **automatizar** las extracciones mediante **procesos**.
Para ello se usan:
...
- **Copias de seguridad y migración** como forma de extracción global. Los materiales
  ...
  de datos (`addons`, `sessions`, `filestore`, normalmente bajo `/var/lib/odoo`). La copia
