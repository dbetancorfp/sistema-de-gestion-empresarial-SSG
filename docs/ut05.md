...
**RA5. Desarrolla componentes para un sistema ERP-CRM analizando y utilizando el lenguaje de
programación incorporado.**

En términos llanos, superar este resultado supone ser capaz de leer y escribir código en el
lenguaje que el ERP-CRM incorpora, y usarlo para ampliar el sistema. Los criterios de
evaluación asociados se cumplen cuando:
...
a un módulo **`base`**, que contiene el funcionamiento básico. Para ampliar o adaptar Odoo
**no se modifica su código fuente**: se crea un módulo. Un módulo puede cambiar el
...
(`/school/<model>/<obj>`) o en **JSON**. Para construir una **API REST** que consuma una
