...
- Departamento de Informática, IES Puerto de la Cruz – Telesforo Bravo. (s. f.). *Instalación y configuración de un ERP-CRM* (Tema 2, Partes 1-2) [Apuntes del módulo Sistemas de Gestión Empresarial].
- Ministerio de Educación y Formación Profesional. (2020). *Instalación y configuración de sistemas ERP-CRM* [Materiales formativos de FP Online].
