...
- *Actividad obligatoria de la Unidad 2: instalación y configuración de un ERP para una pyme* [Supuesto práctico del módulo Sistemas de Gestión Empresarial]. (s. f.).
- Departamento de Informática, IES Puerto de la Cruz – Telesforo Bravo. (s. f.). *Instalación y configuración de un ERP-CRM* (Tema 2, Partes 1-2) [Apuntes del módulo Sistemas de Gestión Empresarial, 2.º DAM].
- *Instalación y configuración de sistemas ERP-CRM* [Materiales del módulo Sistemas de Gestión Empresarial, ciclo de Desarrollo de Aplicaciones Multiplataforma]. (2020).
- *Unidad 2: Instalación y configuración* [Apuntes del módulo Sistemas de Gestión Empresarial]. (2015).
