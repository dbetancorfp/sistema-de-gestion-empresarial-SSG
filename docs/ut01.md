...
- Departamento de Informática, IES Puerto de la Cruz – Telesforo Bravo. (s. f.). *Identificación de sistemas ERP-CRM* (Tema 1) [Apuntes del módulo Sistemas de Gestión Empresarial].
- *Identificación de sistemas ERP-CRM-BI* [Diapositivas del módulo Sistemas de Gestión Empresarial]. (s. f.).
