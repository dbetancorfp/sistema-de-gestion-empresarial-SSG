...
- Departamento de Informática, IES Puerto de la Cruz – Telesforo Bravo. (s. f.). *Identificación de sistemas ERP-CRM* (Tema 1) [Apuntes del módulo Sistemas de Gestión Empresarial, 2.º DAM].
- *Identificación de sistemas ERP-CRM-BI* [Diapositivas del módulo Sistemas de Gestión Empresarial, 2.º DAM]. (s. f.).
- *Introducción a sistemas ERP-CRM* [Material de apoyo en línea]. (2023).
- *Sistemas de gestión empresarial. UD 01: Sistemas ERP-CRM-BI* [Apuntes del módulo Sistemas de Gestión Empresarial]. (2023).
- *Unidad 1: Identificación de sistemas ERP-CRM* [Apuntes del módulo Sistemas de Gestión Empresarial]. (2015).
